  ...
  const I18N = {
    es: {
      ...
      footer: {
        ...
        qr: "Carta QR",
        hours: "Horario",
        hoursText: "Lu–Mi y Ju: 19:00 – 00:00<br>Vi–Sa–Do: 13:30–16:00 / 19:00 – 00:00",
        contact: "Contacto",
    ...
    en: {
      ...
      footer: {
        ...
        qr: "QR menu",
        hours: "Hours",
        hoursText: "Mon–Wed & Thu: 19:00 – 00:00<br>Fri–Sun: 13:30–16:00 / 19:00 – 00:00",
        contact: "Contact",
    ...
    if (footer) {
      footer.innerHTML = `
        <div class="container footer-grid">
          <div>
            <h3>Asador La Estancia</h3>
            <p data-i18n="footer.blurb">${copy.footer.blurb}</p>
          </div>
          <div>
            <h3 data-i18n="footer.menu">${copy.footer.menu}</h3>
            <div class="stack">
              <a href="carta.html" data-i18n="footer.full">${copy.footer.full}</a>
              <a href="galeria.html" data-i18n="footer.gallery">${copy.footer.gallery}</a>
              <a href="qr.html" data-i18n="footer.qr">${copy.footer.qr}</a>
            </div>
          </div>
          <div>
            <h3 data-i18n="footer.hours">${copy.footer.hours}</h3>
            <p data-i18n-html="footer.hoursText">${copy.footer.hoursText}</p>
          </div>
          <div>
            <h3 data-i18n="footer.contact">${copy.footer.contact}</h3>
            <div class="stack">
              <a href="https://www.google.com/maps/search/?api=1&query=Virgen+del+Socorro+79+Alicante" target="_blank" rel="noopener">Virgen del Socorro 79, Alicante</a>
              <a href="tel:+34966350321">+34 966 35 03 21</a>
              <a href="https://wa.me/34966350321" target="_blank" rel="noopener">WhatsApp</a>
              <a href="reservas.html" data-i18n="bookTable">${copy.bookTable}</a>
            </div>
          </div>
        </div>
